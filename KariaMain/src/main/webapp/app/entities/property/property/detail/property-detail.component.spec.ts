...
describe('Property Management Detail Component', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [PropertyDetailComponent, RouterTestingModule.withRoutes([], { bindToComponentInputs: true })],
      providers: [
        provideRouter(
          [
            {
  ...
  describe('OnInit', () => {
    it('Should load property on init', async () => {
      ...
      // THEN
      expect(instance.property).toEqual(expect.objectContaining({ id: 123 }));
    });
  });
